...
public class FloatingActionButton extends View {
    ...
    private final Interpolator hideInterpolator = new AccelerateInterpolator();
    private final Interpolator showInterpolator = new DecelerateInterpolator();
    ...
    public void listenToScrollView(ScrollView scrollView) {
        final ScrollView rootScrollView = scrollView;
        if (null != scrollView) {
